...
function injectCenterPortal() {
  var S = 'style', C = 'center', inp = 'width:100%;background:#0B1A2E;border:1px solid rgba(0,200,150,.12);border-radius:8px;padding:11px 14px;color:#F8F2E0;font-size:14px;outline:none;box-sizing:border-box';
  ...
  portal.innerHTML =
    ...
    '<div style="background:#0B1A2E;border:1px solid rgba(0,200,150,.15);border-radius:20px;padding:0;width:100%;max-width:440px;position:relative;overflow-y:auto;max-height:90vh;scrollbar-width:none;-ms-overflow-style:none">' +
  ...
  dash.style.cssText = 'display:none;position:fixed;inset:0;z-index:10001;background:#0B1A2E;overflow:hidden;height:100vh;width:100vw';
...
function renderDashboard() {
  ...
  // Sidebar
  html += '<aside class="sb" style="background:#0B1A2E;border-right:0.5px solid rgba(0,200,150,.12);display:flex;flex-direction:column;height:100vh;overflow:hidden">';
  ...
  // Topbar
  html += '<div class="top" style="height:50px;border-bottom:0.5px solid rgba(0,200,150,.06);display:flex;align-items:center;padding:0 22px;gap:14px;background:#0B1A2E;flex-shrink:0">';
  ...
  html += '<div class="lang-sw" style="display:flex;background:#0B1A2E;border:0.5px solid rgba(0,200,150,.12);border-radius:7px;overflow:hidden">';
  ...
  if(styleTag) {
    ...
    + '#centerDashboard .sb{background:#0B1A2E;border-right:0.5px solid rgba(0,200,150,.12);display:flex!important;flex-direction:column;height:100vh!important;overflow:hidden;width:220px!important;min-width:220px!important;position:relative;z-index:20}'
    ...
    + '#centerDashboard .top{height:50px;border-bottom:0.5px solid rgba(0,200,150,.06);display:flex;align-items:center;padding:0 22px;gap:14px;background:#0B1A2E;flex-shrink:0}'
    ...
    + '#centerDashboard .kpi{background:#0B1A2E;border:0.5px solid rgba(0,200,150,.12);border-radius:13px;padding:16px 14px;cursor:pointer;transition:all .18s}'
    ...
    + '#centerDashboard .c{background:#0B1A2E;border:0.5px solid rgba(0,200,150,.12);border-radius:13px;overflow:hidden}'
    ...
    + '#centerDashboard .lang-sw{display:flex;background:#0B1A2E;border:0.5px solid rgba(0,200,150,.12);border-radius:7px;overflow:hidden;flex-shrink:0}'
  ...
  + '#centerDashboard .sb{position:fixed!important;left:-260px!important;top:0!important;bottom:0!important;width:250px!important;min-width:250px!important;z-index:100!important;transition:left .3s ease!important;background:#0B1A2E!important;box-shadow:4px 0 30px rgba(0,0,0,.7)}'
